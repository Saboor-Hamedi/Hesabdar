...
export function CalculatorNumpad({ onApplyToPaid, totalPayable = 0, resetKey }: CalculatorNumpadProps) {
  ...
  return (
    <div className="w-full bg-[#FAFAFA] dark:bg-slate-900 border border-gray-200/60 dark:border-slate-800 rounded-[8px] p-2 xl:p-2.5 shadow-[0_1px_3px_rgba(0,0,0,0.04)] flex flex-col gap-1.5 shrink-0 min-h-[250px] transition-colors duration-200">
      {/* 1. Header */}
      <div className="flex items-center justify-between border-b border-gray-200/50 dark:border-slate-800 pb-1 shrink-0">
        <div className="flex items-center gap-1.5 text-[#4A7C6F] dark:text-[#5A8F7B]">
          <Calculator className="w-3.5 h-3.5" />
          <span className="text-xs font-semibold text-[#1F2937] dark:text-slate-100">Cashier Calculator</span>
        </div>
        {totalPayable > 0 && (
          <button
            type="button"
            ...
            className="text-[11px] text-[#4A7C6F] dark:text-[#68A590] hover:underline font-mono font-medium transition-colors cursor-pointer"
      ...
      {/* 2. Digital LCD Screen Display (Dark Slate with White/Cream digits, solid right alignment) */}
      <div className="w-full h-14 min-h-[48px] max-h-[54px] bg-[#1E293B] dark:bg-slate-950 text-slate-100 rounded-[8px] px-3 py-1.5 flex flex-col justify-between font-mono shadow-inner border border-slate-700/40 dark:border-slate-800 shrink-0 overflow-hidden select-none">
        {/* Top Formula / Equation Line */}
        <div className="w-full h-3.5 flex items-center justify-end overflow-hidden">
          <span className="text-[10px] text-slate-400 font-mono tracking-wide truncate select-none leading-none">
            {expression || '\u00A0'}
          </span>
        </div>
      ...
      <div className="w-full grid grid-cols-4 gap-1.5 select-none">
        ...
        <button
          type="button"
          onClick={handleClear}
          className="w-full h-[35px] xl:h-[37px] min-h-[33px] rounded-[8px] bg-rose-50 dark:bg-rose-950/40 hover:bg-rose-100 dark:hover:bg-rose-900/50 active:scale-[0.98] text-rose-700 dark:text-rose-400 font-bold text-xs flex items-center justify-center transition-all cursor-pointer border border-rose-200/60 dark:border-rose-900/50 shadow-[0_1px_2px_rgba(0,0,0,0.02)]"
          title="Clear"
        >
          C
        </button>
        <button
          ...
          className="w-full h-[35px] xl:h-[37px] min-h-[33px] rounded-[8px] bg-slate-100 dark:bg-slate-800 hover:bg-slate-200/80 dark:hover:bg-slate-700 active:scale-[0.98] text-slate-700 dark:text-slate-200 font-semibold text-xs flex items-center justify-center transition-all cursor-pointer border border-slate-200/70 dark:border-slate-700 shadow-[0_1px_2px_rgba(0,0,0,0.02)]"
          title="Backspace"
        >
        ...
        <button
          ...
          className={`w-full h-[35px] xl:h-[37px] min-h-[33px] rounded-[8px] font-semibold text-base flex items-center justify-center transition-all cursor-pointer shadow-[0_1px_2px_rgba(0,0,0,0.02)] active:scale-[0.98] ${
            operator === '÷'
              ? 'bg-[#5A8F7B]/20 dark:bg-[#5A8F7B]/30 text-[#2E4F46] dark:text-[#7EBCA8] font-bold border-2 border-[#5A8F7B]'
              : 'bg-slate-100 dark:bg-slate-800 hover:bg-slate-200/80 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-200/70 dark:border-slate-700'
          }`}
        >
          ÷
        </button>
        ...
        <button
          ...
          className="w-full h-[35px] xl:h-[37px] min-h-[33px] rounded-[8px] bg-white dark:bg-slate-800/90 hover:bg-gray-50 dark:hover:bg-slate-700 active:scale-[0.98] text-slate-800 dark:text-slate-100 font-mono font-semibold text-sm shadow-[0_1px_2px_rgba(0,0,0,0.02)] border border-gray-200/80 dark:border-slate-700 transition-all flex items-center justify-center cursor-pointer"
        >
          7
        </button>
        <button
        ...
        <button
          ...
          className="w-full h-[35px] xl:h-[37px] min-h-[33px] rounded-[8px] bg-[#5A8F7B] hover:bg-[#4A7C6F] active:bg-[#3D665B] active:scale-[0.98] text-white font-bold text-lg shadow-sm flex items-center justify-center transition-all cursor-pointer border-0"
          title="Calculate"
        >
          =
        </button>
      ...
      {onApplyToPaid && (
        <div className="w-full shrink-0 pt-0.5">
          <button
            ...
            className="w-full py-1.5 px-3 h-7 rounded-[7px] bg-white dark:bg-slate-800 hover:bg-[#5A8F7B]/10 dark:hover:bg-[#5A8F7B]/20 active:scale-[0.99] border border-gray-200/80 dark:border-slate-700 text-[#3D665B] dark:text-[#7EBCA8] text-xs font-semibold flex items-center justify-center gap-1.5 transition-all shadow-2xs cursor-pointer"
          >
