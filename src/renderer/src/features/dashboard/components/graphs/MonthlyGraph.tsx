...
/**
 * MonthlyGraph: 30-day continuous revenue & profit area graph.
 * Features dual smooth gradient area fills and interactive data points.
 */
export function MonthlyGraph({ data, height = 220 }: MonthlyGraphProps) {
  ...
  return (
    <div className="relative w-full overflow-hidden select-none">
      ...
      >
        ...
        {coords.map((c, i) => (
          <g key={i}>
            {/* Show every 3rd or 4th label to prevent clutter */}
            {i % 3 === 0 && (
              <text
                x={c.x}
                y={height - 10}
