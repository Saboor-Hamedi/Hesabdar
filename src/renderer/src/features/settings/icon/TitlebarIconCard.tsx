    ...
    >
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 py-1">
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex items-center justify-center w-12 h-12 rounded-[5px] border border-gray-200 bg-gray-50 overflow-hidden shrink-0 shadow-xs">
            {iconUrl ? (
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] px-1.5 py-0.5 rounded-[5px] bg-emerald-50 text-emerald-700 font-medium">
                {t('common.live')}
              </span>
            </div>
